...
def main():
    ...
    libciv.civ_curses_draw_img.restype = c_int
    libciv.civ_curses_draw_img.argtypes = (c_char_p, POINTER(civ_RGB), c_int)
    libciv.civ_curses_draw_img(img_path, palette, 8)
